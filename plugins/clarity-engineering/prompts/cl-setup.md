...
- which MCPs/tools are available, what they are for, and what requires escalation;
- how Review publishes PRs through commits, branches, PR discovery/creation/update, CI, release checks, and evidence;
- what automation is safe without asking and what requires escalation;
...
Keep the setup lightweight. Prefer existing repo conventions. Escalate one focused question only when the answer cannot be discovered from the repo or supplied context.
